...
meson setup build   -Dvulkan-drivers=panfrost   -Dgallium-drivers=   -Dplatforms=x11  -Dprefix=$PREFIX   -Dbuildtype=debugoptimized   -Dbuild-tests=false   -Dpanfrost-kmds=kbase,panthor && ninja -C build install
